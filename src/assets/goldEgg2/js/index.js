import { win, queryString } from "/public/common/js/h5_game_common.js";
import "/public/common/js/swiper.jquery.min.js";
import { } from "/public/common/js/jquery.cookie.js";
$(function () {
    var $hammer = $("#hammer"),
        $tips = $(".info"),
        $eggList = $(".egg li"),//金蛋父级
